...
# Both paths are machine-specific — override via env on the box that runs this.
COMFY_DIR="${COWORK_COMFY_DIR:-$HOME/comfyui}"
OUTDIR="${COWORK_VIDEO_OUTDIR:-$HOME/cowork_video_out}"
